...
ryan_dir = os.environ.get("LABSTACK_BASELINE_DIR", "./baseline_quants")
our_dir = os.environ.get("LABSTACK_QUANTS_DIR", "./results/Salmon_Quants_Ultra")
out_dir = os.environ.get("LABSTACK_OUT_DIR", "./results")
...
if correlations:
    ...
    res_df.to_csv(os.path.join(out_dir, "Ryan_vs_Salmon_Comparison.csv"),
                  index=False)
